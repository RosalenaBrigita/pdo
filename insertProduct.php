    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <div class="database">
                ...
                <h1><center>Insert Data Product</center></h1>
                ...
                <div class="database-data">
                    ...
                    <form action="saveProduct.php" method="post">
                        ...
                        <tr>
                            <td>Product Name</td>
                            <td>:</td>
                            <td><input type="text" name="productName" size="30" required></td>
                        </tr>
                        <tr>
                            <td>Product Line</td>
                            <td>:</td>
                            <td>
                                <select type="text" name="productLine">
                                <option>---</option>
                                <?php
                                include "conn.php";
                                $query = "SELECT * from productlines" or die (mysqli_connect_error($conn));
                        ...
                        <tr>
                            <td>Product Scale</td>
                            <td>:</td>
                            <td><input type="text" name="productScale" size="30" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><input type="text" name="productDescription" size="30" required></td>
                        </tr>
                        <tr>
                            <td>Quantity In Stock</td>
                            <td>:</td>
                            <td><input type="text" name="quantityInStock" size="30" required></td>
                        </tr>
                        <tr>
                            <td>Buy Price</td>
                            <td>:</td>
                            <td><input type="number" name="buyPrice" size="30" required></td>
                        </tr>
                        <tr>
                            <td>MSRP</td>
                            <td>:</td>
                            <td><input type="number" name="MSRP" size="30" required></td>
                        </tr>                                
                        <tr>
                            <td></td>
                            <td></td>
